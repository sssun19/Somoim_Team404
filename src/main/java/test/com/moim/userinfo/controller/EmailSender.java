 ...
 * 
 * @Component public class EmailSender {
 * 
 * @Autowired protected JavaMailSender mailSender;
 * 
 * public void SendEmail(Email email) throws Exception { MimeMessage msg =
 * mailSender.createMimeMessage(); msg.setSubject(email.getSubject());
 * msg.setText(email.getContent()); msg.setRecipient(RecipientType.TO, new
